  ...
  return (
    <section className="min-h-screen pb-24 pt-36 md:pt-44">
      <div className="container-pad">
        <Link
          href="/portfolio"
          className="mb-8 inline-flex items-center gap-2 text-sm text-white/55 transition hover:text-cactus-300"
        >
        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_.9fr] lg:items-start">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.32em] text-cactus-300">
              {project.category}
            </p>
          ...
          {["Challenge", "Solution", "CMS future"].map((title, index) => (
            ...
            >
              ...
              <p className="mt-4 text-sm leading-7 text-white/58">
                {index === 0 &&
                  "The client needed a cleaner digital experience that explained the offer quickly and supported future growth."}
                {index === 1 &&
                  "We planned a sharp interface, clear content structure, reusable components, and scalable frontend patterns."}
                {index === 2 &&
                  "This case study can come from Laravel with images, tags, results, SEO metadata, and publishing controls."}
              </p>
            </div>
          ))}
        </div>
